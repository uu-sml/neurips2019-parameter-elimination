function [xref] = cSMC(Q,R,y,N,xref, as)
% Generate new refernce trajectory using cSMC (keep conditioned path on last place)
% Input: model parameters (Q,R), observations (y), reference
% trajectory (xref), nr particles (N), ancestor sampling (as, do if as=1)
